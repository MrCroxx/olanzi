...
function devicePage() {
  ...
  ${fnPanel()}<section class="surface"><div class="section-heading"><h2>连接帮助</h2></div><div class="help-steps"><div><span>01</span><h3>插入接收器</h3><p>将 AU05 的 USB 接收器连接到这台 Mac。</p></div><div><span>02</span><h3>开启 Vibe Key</h3><p>如果本体未开机，长按电源键开机，再点“重新读取”。</p></div><div><span>03</span><h3>开始配置</h3><p>选择控件、分配键码，最后将更改应用到设备。</p></div></div><p class="help-footnote">出现“无权限”时，检查 macOS 隐私与安全性中的输入监控；出现“被占用”时，检查其他抓包或设备工具。Olanzi 会显示实际错误。</p></section>
