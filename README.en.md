...
The complete phase-1 analysis is in [docs/01-ulanzi-studio-scope.en.md](docs/01-ulanzi-studio-scope.en.md).
...
| Document | Contents |
|---|---|
| **[01 · Studio Scope](docs/01-ulanzi-studio-scope.en.md)** | What Ulanzi Studio actually does, and what is not its job (phase 1) |
| **[02 · Vibe Key Protocol](docs/02-vibekey-protocol.en.md)** | TEA key, frame format, 85-command table, control mapping, **programmable key table** |
| **[03 · Tool Manual](docs/03-tool-manual.en.md)** | Every `vibekey.py` option, output interpretation, troubleshooting |
| **[04 · Methodology](docs/04-methodology.en.md)** | How we reversed it: reproducible steps, key breakthroughs, pitfalls |
| **[05 · Verification Log](docs/05-verification-log.en.md)** | All measured data on record (including failed attempts) |

> Every document exists in **both Chinese and English**; the `.en.md` suffix marks the English version. Both versions are kept in strict structural sync — editing one requires updating the other.
