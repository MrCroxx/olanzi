# 04 · 逆向方法论
> 🌐 [English](04-methodology.en.md)

> 记录**怎么逆出来的**，让整个过程可复现、可审计。
> 结论本身在 [02-vibekey-protocol.md](02-vibekey-protocol.md)，这里讲过程。
>
> 📚 文档集：[README](../README.md) · [01 职责边界](01-ulanzi-studio-scope.md) · [02 协议](02-vibekey-protocol.md) · [03 工具手册](03-tool-manual.md) · [04 逆向方法论](04-methodology.md) · [05 验证记录](05-verification-log.md)
