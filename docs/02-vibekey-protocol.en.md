...
> 🌐 [中文](02-vibekey-protocol.md)

> For the Phase 1 conclusions, see [01-ulanzi-studio-scope.en.md](01-ulanzi-studio-scope.en.md).
> This document records the protocol details and the tool that have been **measured working end to end**.
>
> 📚 Docs set: [README](../README.en.md) · [01 Scope](01-ulanzi-studio-scope.en.md) · **02 Protocol** · [03 Tool Manual](03-tool-manual.en.md) · [04 Methodology](04-methodology.en.md) · [05 Verification Log](05-verification-log.en.md)
