...
> 🌐 [中文](04-methodology.md)

> Records **how this was reverse-engineered**, so the whole process is reproducible and auditable.
> The conclusions themselves are in [02-vibekey-protocol.en.md](02-vibekey-protocol.en.md); this document is about the process.
>
> 📚 Docs set: [README](../README.en.md) · [01 Scope](01-ulanzi-studio-scope.en.md) · [02 Protocol](02-vibekey-protocol.en.md) · [03 Tool Manual](03-tool-manual.en.md) · [04 Methodology](04-methodology.en.md) · [05 Verification Log](05-verification-log.en.md)
