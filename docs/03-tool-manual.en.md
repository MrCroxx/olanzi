...
> 🌐 [中文](03-tool-manual.md)

> One file, zero third-party dependencies, talks to the hardware directly.
> Source: [vibekey.py](../vibekey.py)

> 📚 Docs set: [README](../README.en.md) · [01 Scope](01-ulanzi-studio-scope.en.md) · [02 Protocol](02-vibekey-protocol.en.md) · **03 Tool Manual** · [04 Methodology](04-methodology.en.md) · [05 Verification Log](05-verification-log.en.md)
...
| `--keys` shows `(无回复)` for all six controls | **The Vibe Key itself is powered off** (the dongle is fine) | Press the device's power button to wake it; see [02 §4](02-vibekey-protocol.en.md) for why |
