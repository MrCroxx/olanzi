# 05 · Verification Log
> 🌐 [中文](05-verification-log.md)

> An archive of all measured data, **including the failed attempts**.
> Conclusions are in [02-vibekey-protocol.en.md](02-vibekey-protocol.en.md); the process is in [04-methodology.en.md](04-methodology.en.md).

> 📚 Docs set: [README](../README.en.md) · [01 Scope](01-ulanzi-studio-scope.en.md) · [02 Protocol](02-vibekey-protocol.en.md) · [03 Tool Manual](03-tool-manual.en.md) · [04 Methodology](04-methodology.en.md) · **05 Verification Log**
