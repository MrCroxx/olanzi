...
>
> 📚 Docs set: [README](../README.en.md) · **01 Scope and Responsibility Boundaries** · [02 Protocol](02-vibekey-protocol.en.md) · [03 Tool Manual](03-tool-manual.en.md) · [04 Reverse-Engineering Methodology](04-methodology.en.md) · [05 Verification Log](05-verification-log.en.md)
>
> ⚠️ This document is a **Phase 1** snapshot (written before the protocol was solved); some "to be confirmed" items are **already done**, see §5 and [02](02-vibekey-protocol.en.md).
...
| Can we just write a Studio replacement? | Yes, but the private HID protocol in `kwdm.dylib` must be replicated — **✅ Done, see [02](02-vibekey-protocol.en.md)** |
...
> 6 controls = `01 / 28 / 29 / 46 / 4f / 2a`, see [02 §5](02-vibekey-protocol.en.md).
> **And these key codes are now writable** — see [02 §6 Programmable Key Table](02-vibekey-protocol.en.md).
...
> Evidence and raw data for the completed items are in [05 Verification Log](05-verification-log.en.md).
